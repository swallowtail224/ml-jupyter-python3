...
Linux/MacOS:
    ...
    $ docker run -p 8888:8888 -v /data:/notebooks  --name ml-container -it --rm asashiho/ml-jupyter-python3

Windows:

    $ docker run -p 8888:8888 -v /c/data:/notebooks --name ml-container -it --rm asashiho/ml-jupyter-python3
